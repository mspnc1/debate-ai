...
<body>
  ...
  <div class="footer">
    <div>Generated by DebateAI</div>
    <div>Where AIs Debate. Where Truth Emerges.</div>
  ...
  const generateFilename = () => {
    ...
    return `DebateAI_${cleanTopic}_${ai1}_vs_${ai2}_${date}.pdf`;
  };
