...
export const AI_MODELS: ProviderModels = {
  claude: [
    ...
    },
    {
      ...
      contextLength: 200000,
      isDefault: false, // Free tier default
      supportsVision: true,
      supportsDocuments: true, // Supports PDF files
      supportsFunctions: true,
    },
  ...
  openai: [
    {
      ...
      name: "GPT-5",
      description:
        "Latest flagship model with advanced reasoning (August 2025)",
  ...
  perplexity: [
    ...
    },
    {
      ...
      name: "Sonar Pro",
      description:
        "Advanced model for complex queries with 2x citations and vision",
      contextLength: 200000,
      isPremium: true,
      supportsWebSearch: true,
      supportsVision: true, // Supports image analysis
...
export const CURATED_MODEL_IDS: { [providerId: string]: string[] } = {
  ...
  openai: ["gpt-4o-mini", "gpt-4o", "gpt-4.1", "gpt-5", "gpt-image-1"],
  google: [
    "gemini-2.5-flash",
    "gemini-2.5-pro",
  ...
  cohere: ["command-r-08-2024", "command-r-plus-08-2024", "command-light"],
  together: [
